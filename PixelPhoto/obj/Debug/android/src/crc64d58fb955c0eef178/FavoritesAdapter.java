...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PixelPhoto.Activities.Favorites.Adapters.FavoritesAdapter, PixelPhoto", FavoritesAdapter.class, __md_methods);
	}
	...
	public FavoritesAdapter ()
	{
		...
		if (getClass () == FavoritesAdapter.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.Favorites.Adapters.FavoritesAdapter, PixelPhoto", "", this, new java.lang.Object[] {  });
	}

	public FavoritesAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == FavoritesAdapter.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.Favorites.Adapters.FavoritesAdapter, PixelPhoto", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
