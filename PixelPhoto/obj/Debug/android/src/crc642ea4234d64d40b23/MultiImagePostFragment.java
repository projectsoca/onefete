...
public class MultiImagePostFragment
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PixelPhoto.Activities.Posts.MultiImagePostFragment, PixelPhoto", MultiImagePostFragment.class, __md_methods);
	}


	public MultiImagePostFragment ()
	{
		super ();
		if (getClass () == MultiImagePostFragment.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.Posts.MultiImagePostFragment, PixelPhoto", "", this, new java.lang.Object[] {  });
	}
