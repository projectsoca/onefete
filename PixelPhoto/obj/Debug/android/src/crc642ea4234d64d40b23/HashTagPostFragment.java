...
public class HashTagPostFragment
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PixelPhoto.Activities.Posts.HashTagPostFragment, PixelPhoto", HashTagPostFragment.class, __md_methods);
	}


	public HashTagPostFragment ()
	{
		super ();
		if (getClass () == HashTagPostFragment.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.Posts.HashTagPostFragment, PixelPhoto", "", this, new java.lang.Object[] {  });
	}
