...
public class VideoPostFragment
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PixelPhoto.Activities.Posts.VideoPostFragment, PixelPhoto", VideoPostFragment.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == VideoPostFragment.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.Posts.VideoPostFragment, PixelPhoto", "", this, new java.lang.Object[] {  });
	}
