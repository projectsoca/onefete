...
/** @hide */
	...
	static {
		__md_methods = 
			"n_onKeyboardClose:()V:GetOnKeyboardCloseHandler:Developer.SEmojis.Actions.EmojIconActions/IKeyboardListenerInvoker, SEmojis\n" +
			"n_onKeyboardOpen:()V:GetOnKeyboardOpenHandler:Developer.SEmojis.Actions.EmojIconActions/IKeyboardListenerInvoker, SEmojis\n" +
			"";
		mono.android.Runtime.register ("Developer.SEmojis.Actions.EmojIconActions+IKeyboardListenerImplementor, SEmojis", EmojIconActions_KeyboardListenerImplementor.class, __md_methods);
	}
	...
	public EmojIconActions_KeyboardListenerImplementor ()
	{
		...
		if (getClass () == EmojIconActions_KeyboardListenerImplementor.class)
			mono.android.TypeManager.Activate ("Developer.SEmojis.Actions.EmojIconActions+IKeyboardListenerImplementor, SEmojis", "", this, new java.lang.Object[] {  });
	}
