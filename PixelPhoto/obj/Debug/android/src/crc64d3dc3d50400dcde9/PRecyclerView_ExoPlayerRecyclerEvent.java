...
public class PRecyclerView_ExoPlayerRecyclerEvent
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PixelPhoto.Activities.Posts.Extras.PRecyclerView+ExoPlayerRecyclerEvent, PixelPhoto", PRecyclerView_ExoPlayerRecyclerEvent.class, __md_methods);
	}


	public PRecyclerView_ExoPlayerRecyclerEvent ()
	{
		super ();
		if (getClass () == PRecyclerView_ExoPlayerRecyclerEvent.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.Posts.Extras.PRecyclerView+ExoPlayerRecyclerEvent, PixelPhoto", "", this, new java.lang.Object[] {  });
	}

	public PRecyclerView_ExoPlayerRecyclerEvent (com.google.android.exoplayer2.ui.PlayerControlView p0, crc64d3dc3d50400dcde9.PRecyclerView p1, crc643890d7e1c3d16eb2.Holders_VideoAdapterViewHolder p2)
	{
		super ();
		if (getClass () == PRecyclerView_ExoPlayerRecyclerEvent.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.Posts.Extras.PRecyclerView+ExoPlayerRecyclerEvent, PixelPhoto", "Com.Google.Android.Exoplayer2.UI.PlayerControlView, ExoPlayer.UI:PixelPhoto.Activities.Posts.Extras.PRecyclerView, PixelPhoto:PixelPhoto.Activities.Posts.Adapters.Holders+VideoAdapterViewHolder, PixelPhoto", this, new java.lang.Object[] { p0, p1, p2 });
	}
