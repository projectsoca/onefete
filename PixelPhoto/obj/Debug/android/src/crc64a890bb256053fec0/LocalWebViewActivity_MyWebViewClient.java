...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PixelPhoto.Activities.LocalWebViewActivity+MyWebViewClient, PixelPhoto", LocalWebViewActivity_MyWebViewClient.class, __md_methods);
	}
	...
	public LocalWebViewActivity_MyWebViewClient ()
	{
		...
		if (getClass () == LocalWebViewActivity_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.LocalWebViewActivity+MyWebViewClient, PixelPhoto", "", this, new java.lang.Object[] {  });
	}
	...
	public LocalWebViewActivity_MyWebViewClient (android.app.Activity p0)
	{
		super ();
		if (getClass () == LocalWebViewActivity_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.LocalWebViewActivity+MyWebViewClient, PixelPhoto", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
