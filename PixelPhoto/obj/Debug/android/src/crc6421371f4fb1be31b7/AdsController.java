...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PixelPhoto.MediaPlayer.AdsController, PixelPhoto", AdsController.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == AdsController.class)
			mono.android.TypeManager.Activate ("PixelPhoto.MediaPlayer.AdsController, PixelPhoto", "", this, new java.lang.Object[] {  });
	}

	public AdsController (android.content.Context p0)
	{
		super ();
		if (getClass () == AdsController.class)
			mono.android.TypeManager.Activate ("PixelPhoto.MediaPlayer.AdsController, PixelPhoto", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
