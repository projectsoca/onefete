...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PixelPhoto.NiceArt.MultiTouchListener+GestureListener, PixelPhoto", MultiTouchListener_GestureListener.class, __md_methods);
	}
	...
	public MultiTouchListener_GestureListener ()
	{
		...
		if (getClass () == MultiTouchListener_GestureListener.class)
			mono.android.TypeManager.Activate ("PixelPhoto.NiceArt.MultiTouchListener+GestureListener, PixelPhoto", "", this, new java.lang.Object[] {  });
	}
