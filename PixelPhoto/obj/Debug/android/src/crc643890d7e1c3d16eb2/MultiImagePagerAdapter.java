...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PixelPhoto.Activities.Posts.Adapters.MultiImagePagerAdapter, PixelPhoto", MultiImagePagerAdapter.class, __md_methods);
	}
	...
	public MultiImagePagerAdapter ()
	{
		...
		if (getClass () == MultiImagePagerAdapter.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.Posts.Adapters.MultiImagePagerAdapter, PixelPhoto", "", this, new java.lang.Object[] {  });
	}
