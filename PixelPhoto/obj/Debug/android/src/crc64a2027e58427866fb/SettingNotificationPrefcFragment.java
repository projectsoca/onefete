package crc64a2027e58427866fb;


public class SettingNotificationPrefcFragment
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PixelPhoto.Activities.SettingsUser.Notification.SettingNotificationPrefcFragment, PixelPhoto", SettingNotificationPrefcFragment.class, __md_methods);
	}


	public SettingNotificationPrefcFragment ()
	{
		super ();
		if (getClass () == SettingNotificationPrefcFragment.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.SettingsUser.Notification.SettingNotificationPrefcFragment, PixelPhoto", "", this, new java.lang.Object[] {  });
	}

	public SettingNotificationPrefcFragment (android.app.Activity p0)
	{
		super ();
		if (getClass () == SettingNotificationPrefcFragment.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.SettingsUser.Notification.SettingNotificationPrefcFragment, PixelPhoto", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
