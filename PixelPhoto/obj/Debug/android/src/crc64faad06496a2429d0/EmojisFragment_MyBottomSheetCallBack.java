...
public class EmojisFragment_MyBottomSheetCallBack
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PixelPhoto.Activities.Editor.Tools.EmojisFragment+MyBottomSheetCallBack, PixelPhoto", EmojisFragment_MyBottomSheetCallBack.class, __md_methods);
	}


	public EmojisFragment_MyBottomSheetCallBack ()
	{
		super ();
		if (getClass () == EmojisFragment_MyBottomSheetCallBack.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.Editor.Tools.EmojisFragment+MyBottomSheetCallBack, PixelPhoto", "", this, new java.lang.Object[] {  });
	}
