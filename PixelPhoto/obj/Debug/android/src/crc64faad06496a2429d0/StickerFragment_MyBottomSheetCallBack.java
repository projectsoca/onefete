...
public class StickerFragment_MyBottomSheetCallBack
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PixelPhoto.Activities.Editor.Tools.StickerFragment+MyBottomSheetCallBack, PixelPhoto", StickerFragment_MyBottomSheetCallBack.class, __md_methods);
	}


	public StickerFragment_MyBottomSheetCallBack ()
	{
		super ();
		if (getClass () == StickerFragment_MyBottomSheetCallBack.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.Editor.Tools.StickerFragment+MyBottomSheetCallBack, PixelPhoto", "", this, new java.lang.Object[] {  });
	}
