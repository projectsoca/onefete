...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PixelPhoto.Activities.Tabbes.Adapters.SuggestionsAdapter, PixelPhoto", SuggestionsAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == SuggestionsAdapter.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.Tabbes.Adapters.SuggestionsAdapter, PixelPhoto", "", this, new java.lang.Object[] {  });
	}

	public SuggestionsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == SuggestionsAdapter.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.Tabbes.Adapters.SuggestionsAdapter, PixelPhoto", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
