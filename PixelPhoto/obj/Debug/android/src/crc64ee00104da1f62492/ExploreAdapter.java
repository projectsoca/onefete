...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PixelPhoto.Activities.Tabbes.Adapters.ExploreAdapter, PixelPhoto", ExploreAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ExploreAdapter.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.Tabbes.Adapters.ExploreAdapter, PixelPhoto", "", this, new java.lang.Object[] {  });
	}

	public ExploreAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == ExploreAdapter.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Activities.Tabbes.Adapters.ExploreAdapter, PixelPhoto", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
