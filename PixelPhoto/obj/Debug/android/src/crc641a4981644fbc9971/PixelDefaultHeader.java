...
public class PixelDefaultHeader
	extends com.liaoinstan.springview.container.BaseHeader
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PixelPhoto.Helpers.PullSwipeStyles.PixelDefaultHeader, PixelPhoto", PixelDefaultHeader.class, __md_methods);
	}


	public PixelDefaultHeader ()
	{
		super ();
		if (getClass () == PixelDefaultHeader.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Helpers.PullSwipeStyles.PixelDefaultHeader, PixelPhoto", "", this, new java.lang.Object[] {  });
	}

	public PixelDefaultHeader (android.app.Activity p0)
	{
		super ();
		if (getClass () == PixelDefaultHeader.class)
			mono.android.TypeManager.Activate ("PixelPhoto.Helpers.PullSwipeStyles.PixelDefaultHeader, PixelPhoto", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
